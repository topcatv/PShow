...
import org.pshow.repository.mybatis.RoleDao;
import org.pshow.repository.mybatis.UserDao;
...
public class AccountService {
    ...
    private void entryptPassword(User user) {
        ...
        byte[] hashPassword = digest(user.getPlainPassword().getBytes(), "SHA-1", salt, HASH_INTERATIONS);
    ...
    public List<Role> getRolesByUser(User user){
        return roleDao.getRolesByUser(user.getId());
    }
