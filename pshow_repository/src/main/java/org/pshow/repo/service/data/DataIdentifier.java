package org.pshow.repo.service.data;

import java.io.Serializable;

/**
 * Opaque data identifier used to identify records in a data store. All
 * identifiers must be serializable and implement the standard object equality
 * and hash code methods.
 */
public final class DataIdentifier implements Serializable {
     ...
     */
    private static final char[] HEX              = "0123456789abcdef"
                                                         .toCharArray();
    ...
    /**
     * Creates a data identifier from the hexadecimal string representation of
     * the given bytes.
     * 
     * @param identifier
     *            data identifier
    ...
    /**
     * Checks if the given object is a data identifier and has the same string
